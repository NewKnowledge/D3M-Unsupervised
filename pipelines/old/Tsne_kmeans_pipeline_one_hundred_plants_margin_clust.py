...
# Step 5: DISTIL primitive -> unsupervised clustering, n_clusters set for kmeans, cluster_col_name is the target name
step_5 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.clustering.k_means.DistilKMeans'))
step_5.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
step_5.add_hyperparameter(name='n_clusters', argument_type= ArgumentType.VALUE, data=100)
step_5.add_hyperparameter(name = 'cluster_col_name', argument_type=ArgumentType.VALUE, data='Class')
...
step_6.add_argument(name='reference', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
