...
step_5 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.dimensionality_reduction.t_distributed_stochastic_neighnor_embedding.Tsne'))
...
# Step 5: DISTIL/NK Storc primitive -> unsupervised clustering, n_clusters set for kmeans
