...
# Step 3: DISTIL/NK Hdbscan primitive -> unsupervised clustering of records with a label
...
# Step 4: imputer -> imputes null values based on mean of column
...
step_6.add_argument(name='reference', argument_type=ArgumentType.CONTAINER, data_reference='steps.3.produce')
