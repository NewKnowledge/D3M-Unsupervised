...
# Step 1, 2 column parser -> labeled semantic types to data types
...
# (mapped to operate on a dataset object instead of a dataframe object)
...
# Step 3,4: imputer -> imputes null values based on mean of column
...
step_5.add_hyperparameter(name='cluster_selection_method', argument_type=ArgumentType.VALUE, data='leaf')
step_5.add_output('produce')
pipeline_description.add_step(step_5)

# Step 6,7,8: Distil ensemble random forest classifier
...
# Step 9, 10: construct predictions dataframe in proper format
